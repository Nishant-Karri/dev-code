"""
AWS Glue Job: Read JSON from S3, select id, name, phone_number, and address columns,
convert to Parquet, write to different S3 location. Also runs MSCK REPAIR TABLE on
the target Athena table.
...
# ---------------------------------------------------------------------------
# Select id, name, phone_number, and address columns
# ---------------------------------------------------------------------------
...
print("Selected columns: id, name, phone_number, address")
